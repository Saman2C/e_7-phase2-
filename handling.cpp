...
void Handling::sell_player(int num_week, User *current_user) {
    ...
    if (player == NULL) {
        ...
        current_user->change_budget(player->get_price());
...
void Handling::find_players_playing(string names, vector<team *> teams, int num_week) {
    ...
    getline(ss, word, ';');
    player_in_match(word, "left", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "middle", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "middle", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "right", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "midfielder", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "midfielder", teams, num_week);
    getline(ss, word, ';');
    player_in_match(word, "midfielder", teams, num_week);
